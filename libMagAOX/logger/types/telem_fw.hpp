/** \file telem_fw.hpp
  * \brief The MagAO-X logger telem_fw log type.
  * \author Irina Stefan (istefan@arizona.edu)
  *
  * \ingroup logger_types_files
  */
#ifndef logger_types_telem_fw_hpp
#define logger_types_telem_fw_hpp

#include "generated/telem_fw_generated.h"
...
/// Log entry recording ESC FW telemetry
/** \ingroup logger_types
  */
struct telem_fw : public flatbuffer_log
{

  static const flatlogs::eventCodeT eventCode = eventCodes::TELEM_FW;
  ...
  static timespec lastRecord; ///< The time of the last time this log was recorded.  Used by the telemetry system.
   ...
   struct messageT : public fbMessage
   {
        ...
        {
        auto fp = CreateTelem_fw_fb(builder, P1V2, P2V2, P28V, P2V5, P6V, P5V, P3V3D, P4V3, P2I2, P4I3, P6I);
        builder.Finish(fp);
        }
   };
                     ...
                     )
   {
      ...
      return VerifyTelem_fw_fbBuffer(verifier);
   }
                               ...
                               )
   {
    ...
    auto fbs = GetTelem_fw_fb(msgBuffer);
    ...
    msg += "P2I2: ";
    msg += std::to_string(fbs->P2I2()) + " A ";

    msg += "P4I3: ";
    msg += std::to_string(fbs->P4I3()) + " A ";

    msg += "P6I: ";
    msg += std::to_string(fbs->P6I()) + " A ";
    ...
    static logMetaDetail getAccessor( const std::string & member /**< [in] the name of the member */ )
    {
      ...
      {
        std::cerr << "No member " << member << " in telem_fw\n";
...
#endif //logger_types_telem_fw_hpp
