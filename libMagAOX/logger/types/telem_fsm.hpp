  ...
  static timespec lastRecord; ///< The time of the last time this log was recorded.  Used by the telemetry system.
                               ...
                               )
   {
    ...
    static logMetaDetail getAccessor( const std::string & member /**< [in] the name of the member */ )
    {
      ...
      else if(member == "P3V3A") return logMetaDetail({"P3V3A", "", logMeta::valTypes::Double, logMeta::metaTypes::Continuous, reinterpret_cast<void*>(&P3V3A), false});
      ...
      else if(member == "N5V") return logMetaDetail({"N5V", "", logMeta::valTypes::Double, logMeta::metaTypes::Continuous, reinterpret_cast<void*>(&N5V), false});
      else if(member == "N6V") return logMetaDetail({"N6V", "", logMeta::valTypes::Double, logMeta::metaTypes::Continuous, reinterpret_cast<void*>(&N6V), false});
      else if(member == "P150V") return logMetaDetail({"P150V", "", logMeta::valTypes::Double, logMeta::metaTypes::Continuous, reinterpret_cast<void*>(&P150V), false});
      else
      {
