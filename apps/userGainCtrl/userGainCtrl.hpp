...
int userGainCtrl::writeGains()
{
   ...
   clock_gettime(CLOCK_ISIO, &shmimMonitorT::m_imageStream.md->writetime);
...
int userGainCtrl::writeMCs()
{
   ...
   //Set the time of last write
   clock_gettime(CLOCK_ISIO, &mcShmimMonitorT::m_imageStream.md->writetime);
...
int userGainCtrl::writeLimits()
{
   ...
   //Set the time of last write
   clock_gettime(CLOCK_ISIO, &limitShmimMonitorT::m_imageStream.md->writetime);
